            ...
            <div  style={{backgroundImage: `url(${bgshaow})`}}
             className='bg-no-repeat bg-cover bg-center py-20'>
                ...
                <div className='py-10 flex flex-col justify-center items-center text-center'>
                    <h1 className='font-bold text-xl md:text-4xl text-white text-center items-center'>Assemble Your Ultimate Dream 11 Cricket Team</h1>
                    <p className='font-normal text-sm text-gray-200 text-center items-center py-4'>Beyond Boundaries Beyond Limits</p>
